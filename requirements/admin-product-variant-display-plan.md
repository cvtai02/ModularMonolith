...
- If admin editing is added from this view:
  - `PUT /api/ProductCatalog/products/{id}` uses `UpdateProductParams`, `UpdateProductRequest`, and `UpdateProductResponse`.
...
- array or paginated category result as generated by `api-types.ts`.
